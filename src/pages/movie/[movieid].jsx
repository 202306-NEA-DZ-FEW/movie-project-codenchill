...
export function MovieDetailInfo({ movie, director }) {
  ...
  return (
    <div className="mx-auto max-w-7xl bg-gradient-to-r from-gray-800 to-red-500 p-4 rounded-lg shadow-lg text-white mt-8 flex flex-wrap space-x-0 space-y-2 md:space-x-4 relative">
      <div className="flex flex-wrap mx-auto max-w-5xl">
        <div className="w-full md:w-1/2 text-center">
          ...
          <button
            className="bg-gray-500 absolute top-4 right-4 px-3 py-2 rounded-lg text-lg font-semibold text-white"
            style={{ zIndex: 1 }}
          >
            {`${rating.toFixed(1)}/10`}
          </button>
